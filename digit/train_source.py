...
from data_list_src import DigitFiveList
...
def data_load(args): 
    ...
    dsets["source_tr"] = DigitFiveList(args, args.s_dset_path, transform=transform_dig)
    ...
    dsets["source_te"] = DigitFiveList(args, args.s_dset_path, transform=transform_dig)
...
if __name__ == "__main__":
    ...
    args.s_dset_path = folder + args.dset + '/' + names[args.s] + '.mat'
    args.test_dset_path = folder + args.dset + '/' + names[args.s] + '.mat'
